...
/datum/map_template/ruin/space/nova/derelictferry
	...
	description = "Clearly once a ferry fielded by Sectorial Command to send their staff to nearby stations, this ship's seen better days." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command to send their staff to nearby stations, this ship's seen better days."
