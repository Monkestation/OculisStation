...
/datum/config_entry/string/alert_epsilon_upto
	config_entry_value = "Nanotrasen Sectorial Command has declared the station under full CentCom authority. All CentCom personnel and representatives now hold absolute control of the station and its assets. Crew cooperation is compulsory. Have a Secure Day!" // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command has declared the station under full CentCom authority. All CentCom personnel and representatives now hold absolute control of the station and its assets. Crew cooperation is compulsory. Have a Secure Day!"

/datum/config_entry/string/alert_epsilon_downto
	config_entry_value = "The Sol Goverment has released Military Command and action over the station. Sectorial Command is now in full command authority of the station, comply with all instructions from Nanotrasen Sectorial Command staff, Crew cooperation is compulsory! Have a Secure Day!" // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command staff, Crew cooperation is compulsory! Have a Secure Day!"
