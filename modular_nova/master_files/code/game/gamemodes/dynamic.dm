...
/datum/communciations_controller/proc/send_trait_report(greenshift)
	. = "<b><i>Sectorial Command Status Summary</i></b><hr>" // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command Status Summary</i></b><hr>"
	...
	print_command_report(., "Sectorial Command Status Summary", announce = FALSE) // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command Status Summary", announce = FALSE)
