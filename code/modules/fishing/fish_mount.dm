...
/obj/structure/fish_mount/proc/add_first_fish()
	...
	var/fluff_name = pick("John Trasen III", "a nameless intern", "Pun Pun", AQUARIUM_COMPANY, "Unknown", "Sectorial Command") // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command")
