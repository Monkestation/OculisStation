...
ADMIN_VERB(change_command_name, R_ADMIN, "Change Command Name", "Change the name of Sectorial Command.", ADMIN_CATEGORY_EVENTS) // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command.", ADMIN_CATEGORY_EVENTS)
	var/input = input(user, "Please input a new name for Sectorial Command.", "What?", "") as text|null // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command.", "What?", "") as text|null
	if(!input)
		return
	change_command_name(input)
	message_admins("[key_name_admin(user)] has changed Sectorial Command's name to [input]") // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command's name to [input]")
	log_admin("[key_name(user)] has changed the Sectorial Command name to: [input]") // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command name to: [input]")
