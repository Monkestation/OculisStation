...
/datum/design/error_design
	name = "ERROR"
	desc = "This usually means something in the database has corrupted. If this doesn't go away automatically, inform Sectorial Command so their techs can fix this ASAP(tm)" // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command so their techs can fix this ASAP(tm)"
