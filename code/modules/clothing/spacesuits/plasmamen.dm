...
/obj/item/clothing/head/helmet/space/plasmaman/centcom_commander
	...
	desc = "A special containment helmet designed for the Higher Sectorial Command Staff. Not many of these exist, as CentCom does not usually employ plasmamen to higher staff positions due to their complications." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command Staff. Not many of these exist, as CentCom does not usually employ plasmamen to higher staff positions due to their complications."
