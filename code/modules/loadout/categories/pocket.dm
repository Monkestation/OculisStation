...
/datum/loadout_item/pocket_items/borg_me_dogtag/proc/apply_after_setup(mob/living/carbon/human/source, ...)
	...
	record?.medical_notes += new /datum/medical_note("Sectorial Command", "Patient is a registered brain donor for Robotics research.", null) // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command", "Patient is a registered brain donor for Robotics research.", null)
