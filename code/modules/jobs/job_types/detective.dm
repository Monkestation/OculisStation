/datum/job/detective
	title = JOB_DETECTIVE
	description = "Investigate crimes, gather evidence, perform interrogations." /// keygenpie edit
	...
	mail_goodies = list(
		/// /obj/item/storage/fancy/cigarettes = 25, (keygenpie edit)
...
/datum/outfit/job/detective
	...
	/// mask = /obj/item/cigarette (keygenpie edit)
...
/datum/outfit/job/detective/pre_equip(mob/living/carbon/human/human, visuals_only = FALSE)
	...
	if (human.age < AGE_MINOR)
		/// mask = /obj/item/cigarette/candy (keygenpie edit)
