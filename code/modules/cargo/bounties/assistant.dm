...
/datum/bounty/item/assistant/toolbox
	...
	description = "There's an absence of robustness at Sectorial Command. Ship them a fully packed toolbox as a solution, containing a screwdriver, wrench, welding tool, crowbar, analyzer, and wirecutters." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command. Ship them a fully packed toolbox as a solution, containing a screwdriver, wrench, welding tool, crowbar, analyzer, and wirecutters."
	reward = CARGO_CRATE_VALUE * 4
...
/datum/bounty/item/assistant/statue
	name = "Statue"
	description = "Sectorial Command would like to commission an artsy statue for the lobby. Ship one out, when possible." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command would like to commission an artsy statue for the lobby. Ship one out, when possible."
	reward = CARGO_CRATE_VALUE * 4
...
/datum/bounty/item/assistant/potted_plants
	name = "Potted Plants"
	description = "Sectorial Command is looking to commission a new BirdBoat-class station. You've been ordered to supply the potted plants." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command is looking to commission a new BirdBoat-class station. You've been ordered to supply the potted plants."
	reward = CARGO_CRATE_VALUE * 4
	required_count = 3
	wanted_types = list(
...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, Sectorial Command is in serious need of monkeys. Your mission is to ship monkey cubes." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward = CARGO_CRATE_VALUE * 4
	required_count = 3
