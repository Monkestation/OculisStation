...
/obj/item/mmi/posibrain/attack_self(mob/user)
	...
	if(!(GLOB.ghost_role_flags & GHOSTROLE_SILICONS))
		to_chat(user, span_warning("Sectorial Command has temporarily outlawed posibrain sentience in this sector...")) // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command has temporarily outlawed posibrain sentience in this sector..."))
	if(is_occupied())
