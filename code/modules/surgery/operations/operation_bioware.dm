...
/datum/surgery_operation/limb/bioware/vein_threading/mechanic
	...
	desc = "Optimize the routing of a robotic patient's hydraulics system, reducing fluid loss from leaks." // OCULIS EDIT, ORIGINAL: desc = "Optimize the routing of a robotic patient's hydraulic system, reducing fluid loss from leaks."
...
/datum/surgery_operation/limb/bioware/muscled_veins/mechanic
	...
	desc = "Add redundancies to a robotic patient's hydraulics system, allowing it to pump fluids without an engine or pump." // OCULIS EDIT, ORIGINAL: desc = "Add redundancies to a robotic patient's hydraulic system, allowing it to pump fluids without an engine or pump."
	required_bodytype = BODYTYPE_ROBOTIC
	operation_flags = parent_type::operation_flags | OPERATION_MECHANIC
