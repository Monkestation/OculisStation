...
#define EXP_TYPE_CENTRAL_COMMAND "Sectorial Command" // NOVA EDIT ADD // OCULIS EDIT, SectCommening 2, ORIGINAL: #define EXP_TYPE_CENTRAL_COMMAND "Central Command" // NOVA EDIT ADD
