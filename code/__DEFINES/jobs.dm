...
#define DEPARTMENT_CENTRAL_COMMAND "Sectorial Command" //NOVA EDIT CHANGE // OCULIS EDIT, SectCommening 2, ORIGINAL: #define DEPARTMENT_CENTRAL_COMMAND "Central Command" //NOVA EDIT CHANGE
