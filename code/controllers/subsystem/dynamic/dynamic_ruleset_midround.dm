...
/datum/dynamic_ruleset/midround/from_ghosts/fugitives/proc/spawn_hunters()
	...
	switch(hunter_backstory)
		...
		if(HUNTER_PACK_MI13)
			announcement_text_list += "Illegal intrusion detected in the crew monitoring network. Sectorial Command has been informed." // OCULIS EDIT, SectCommening 2, ORIGINAL: .*Central Command has been informed."
