...
/obj/item/mail/proc/junk_mail()
	...
	var/list/junk_names = list(
		...
		/obj/item/paper/pamphlet/violent_video_games = "[initial(name)] for the truth about the arcade centcom doesn't want to hear", // OCULIS EDIT, ORIGINAL: /obj/item/paper/pamphlet/violent_video_games = "[initial(name)] for the truth about the arcade centcom doesn't want to hear",
