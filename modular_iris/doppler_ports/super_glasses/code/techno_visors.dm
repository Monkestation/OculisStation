...
/obj/item/clothing/glasses/techno_visor/setup_reskins()
	AddComponent(/datum/component/reskinable_item, /datum/atom_skin/techno_visor, infinite_reskin = TRUE) // OCULIS EDIT, ORIGINAL: AddComponent(/datum/component/reskinable_item, /datum/atom_skin/techno_visor)
