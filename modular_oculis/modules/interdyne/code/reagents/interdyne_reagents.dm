...
/obj/item/reagent_containers/cup/jerrycan/interdyne_dynexil
	name = "Dynexil Jerrycan"
	desc = "A Jerrycan of Interdyne's proprietary Dynexil stabilizing compound. Required for Interdyne pharmaceutical formulations."
	list_reagents = list(/datum/reagent/medicine/interdyne/dynexil = 200)
