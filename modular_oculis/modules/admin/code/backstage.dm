...
ADMIN_VERB(togglebackstage, R_ADMIN, "Toggle Backstage OOC", "Toggles Backstage OOC.", ADMIN_CATEGORY_SERVER)
	...
	SSblackbox.record_feedback("nested tally", "admin_toggle", 1, list("Toggle Backstage OOC", "[GLOB.backstage_allowed ? "Enabled" : "Disabled"]")) //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
